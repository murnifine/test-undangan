    ...
    return (
        <div className='w-full h-full py-20 '>
            <div className="flex flex-col items-center  gap-5 py-20 px-5 md:px-10 w-full  h-full bg-white">
                ...
                <div className='flex flex-col gap-2 pb-20 h-max'>
                    <div className=" grid md:grid-cols-2 lg:grid-cols-3 flex-col md:flex-row items-center gap-8 md:gap-12 mt-2  py-5  w-full h-full">
                        {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((template) => (
